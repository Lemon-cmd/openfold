...
def make_data_config(
    ...
    mode_cfg = cfg.data[mode]
    with cfg.unlocked():
        if mode_cfg.crop_size is None:
            mode_cfg.crop_size = num_res

    feature_names = cfg.data.common.unsupervised_features

    if cfg.data.common.use_templates:
        feature_names += cfg.data.common.template_features

    if cfg.data[mode].supervised:
        feature_names += cfg.data.supervised.supervised_features
